...
<div class="main-container container">
        ...
        <div class="col-10 mx-auto profile-page">
            ...
            <div class="row my-3 py-5">
                <div class="col-7 align-self-center">
                    <h1 class="mb-2"><span class="fw-light text-secondary">Hasil</span><br />Quiz</h1>
                    
                </div>
                <div class="col align-self-center">
                    <figure class="avatar avatar-70 rounded-20 p-1 bg-white shadow-sm text-50">
                        {{$report->nilai}} 
                         </figure>
                </div>
                <div class="col-12">
                    ...
                    <br>
                    <p class=""> 
                      Soal Benar : {{$report->benar}}  <br> 
                    Soal Salah : {{$report->salah}} </p>
                </div>
    ...
    <div class="row mb-4">
        ...
        <br>
        <div class="col-12">
            <a href="{{url('user')}}" class="btn btn-default btn shadow-sm w-100">Kembali</a>
        </div>
    </div>
